  ...
  render() {
    return (
      ...
      <div className="vetservicesPage">
        ...
        <p>
        Honest To Dog’s Fear Free® certified animal trainer can train your veterinary, grooming or daycare team in the hands-on strategies used by the most innovative pet professionals to keep their patients and clients calm, cooperative and happy. Plus, when you make the experience more pleasant for the animals, you earn their owners’ appreciation and trust and often foster long-term relationships with them.
        </p>
        <p>
        Workshops are available for small or large groups in veterinary, grooming and daycare settings.
        </p>
        <p>
        ...
        <p>
        What Animals Are Saying – learn animal body language to ensure you are sending the “right” message in advertising, or to keep your employees safe in the field.
        </p>
        <p>
        Bring Your Dog To Work – Establish a day or on-going program for employees to bring their dog to work. Bringing dogs to work is a great way to enhance employee morale and productivity. It’s all fun and games but needs a well managed program so everyone feels safe and respected.
        </p>
        <p>
